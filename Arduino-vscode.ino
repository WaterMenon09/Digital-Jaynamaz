...
void loop()
{
  ...
  Serial.print(" Rakat No: ");
  Serial.println(count);

  if (state==(1,3,7,9,14,16,20,22))
  {
    Serial.print("Standing...");
  }
  else if (state==(2,8,15,21))
  {
    Serial.print("In Ruku...");
  }
  else if (state==(4,6,10,12,17,19,23,25))
  {
    Serial.print("In Sizdah...");
  }
  else if (state==(5,11,13,18,24,26))
  {
    Serial.print("Sitting...");
  }
